...
export default function Workspace() {
  // Static data for the icons
  const iconData = [
    {
      src: '/icons/sparkles-dark.svg',
      alt: 'Icon 1',
      label: 'Sparkles',
      description: 'Description for Sparkles Icon',
    },
    {
      src: '/calendaricon.png',
      alt: 'Icon 2',
      label: 'Calendar',
      description: 'Description for Calendar Icon',
    },
    {
      src: '/emailicon.png',
      alt: 'Icon 3',
      label: 'Email',
      description: 'Description for Email Icon',
    },
    {
      src: '/messagingicon.png',
      alt: 'Icon 4',
      label: 'Messaging',
      description: 'Description for Messaging Icon',
    },
    {
      src: '/formicon.png',
      alt: 'Icon 5',
      label: 'Form',
      description: 'Description for Form Icon',
    },
    {
      src: '/meetingicon.png',
      alt: 'Icon 6',
      label: 'Meeting',
      description: 'Description for Meeting Icon',
    },
  ];
