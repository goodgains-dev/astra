                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                                Build your next idea and ship your dream product
                            </h1>
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Three reasons to build your dream idea
                        </h2>
                        <p className="text-muted-foreground mt-6">
                            Turn your vision into reality with GoodGains
                        </p>
                    </div>
                </Container>
                <Container>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full gap-8">
                            {features.map((feature, index) => (
                                <div key={feature.title} className="flex flex-col items-start lg:items-start px-0 md:px-0">
                                    <label htmlFor={`video-modal-${index}`} className="cursor-pointer flex items-center justify-center">
                                    ...
                                    {/* Hidden Checkbox for Video Modal */}
                                    <input type="checkbox" id={`video-modal-${index}`} className="hidden peer" />

                                    {/* Video Modal */}
                                    <div className="fixed inset-0 z-50 hidden bg-black bg-opacity-80 items-center justify-center peer-checked:flex">
                                        <div className="relative bg-white rounded-lg shadow-lg p-6 max-w-lg w-full">
                                            <label htmlFor={`video-modal-${index}`} className="absolute top-2 right-2 text-black cursor-pointer">
                                                ✕
                                            </label>
                                            <div className="relative">
                                                <video controls src={`/videos/video${index + 1}.mp4`} className="rounded-md shadow-md w-full" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {pricingCards.map((card) => (
                            ...
                            >
                                ...
                                <CardFooter className="mt-auto">
                                    <Link href="#" className={cn("w-full text-center text-primary-foreground bg-primary p-2 rounded-md text-sm font-medium",
