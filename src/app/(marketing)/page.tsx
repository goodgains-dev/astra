...
const HomePage = () => {
  const sections = [
    { id: 0, title: "", video: "/goodgains1.mp4" },
    { id: 1, title: "Creation Simplified", video: "/codevid.mp4", learnMoreHref: "/learn-more-creation", workflowHref: "/index.html" },
    { id: 2, title: "Organization Simplified", video: "/Organizationvid.mp4", learnMoreHref: "/learn-more-organization", workflowHref: "/index2.html" },
    { id: 3, title: "Design Simplified", video: "/Digital Presentation_1.mp4", learnMoreHref: "/learn-more-design", workflowHref: "/index3.html" },
    { id: 4, title: "Analysis Simplified", video: "/analysissimplified.mp4", learnMoreHref: "/learn-more-analysis", workflowHref: "/index4.html" },
    { id: 5, title: "Marketing Simplified", video: "/Marketingvid.mp4", learnMoreHref: "/learn-more-marketing", workflowHref: "/index5.html" },
  ];
    ...
    <>
      ...
      <main className="w-full">
        ...
        {sections.slice(1).map((section, index) => (
          <section key={section.id} className="relative h-screen p-5 md:p-10 flex flex-col items-center justify-center overflow-hidden" style={styles[`section${index + 1}`]}>
